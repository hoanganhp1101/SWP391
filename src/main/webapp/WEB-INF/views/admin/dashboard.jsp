...
<nav class="top-navbar d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center">
        <a href="#" class="brand">HealthAlert</a>
        <div class="d-flex">
...
<div class="app-container">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="#"><i class="fas fa-exclamation-triangle"></i> Emergency Alerts</a></li>
            <li><a href="#"><i class="fas fa-clipboard-list"></i> Medical History</a></li>
    ...
    <main class="main-content d-flex flex-column">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Real-time status of HealthAlert network operations.</p>
            </div>
            <div class="d-flex gap-2">
                <button class="btn btn-outline-secondary btn-sm bg-white fw-medium px-3 rounded-pill">Export Logs</button>
                <button class="btn btn-primary btn-sm fw-medium px-3 rounded-pill" style="background-color: var(--primary-blue); border:none;">Refresh Data</button>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4">
                <div class="custom-card alert-card">
                    ...
                    <div class="stat-card-title position-relative z-1">Active Alerts</div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-8">
                <div class="custom-card">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="h6 mb-0 fw-bold text-dark">Staff Access Control</h5>
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-search"></i></span>
                            <input type="text" class="form-control border-start-0 ps-0 shadow-none" placeholder="Filter by name or role">
                        </div>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="avatar-sm" style="background:#dbeafe; color:#1e40af;">JD</div>
                                        <div>
                                            <div class="fw-bold" style="font-size:0.85rem;">Dr. Jane Doe</div>
                                            <div class="text-muted" style="font-size:0.75rem;">jane.doe@healthalert.com</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-muted small">Oncologist</td>
                                <td class="text-muted small">12 mins ago</td>
                                <td><span class="badge-active">Active</span></td>
                                <td class="text-end"><i class="fas fa-ellipsis-v text-muted" style="cursor:pointer;"></i></td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="avatar-sm" style="background:#e0f2fe; color:#0369a1;">MB</div>
                                        <div>
                                            <div class="fw-bold" style="font-size:0.85rem;">Marcus Bell</div>
                                            <div class="text-muted" style="font-size:0.75rem;">m.bell@healthalert.com</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-muted small">IT Admin</td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <div class="fw-bold" style="font-size:0.85rem;">Sarah Lee</div>
                                            <div class="text-muted" style="font-size:0.75rem;">s.lee@healthalert.com</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-muted small">Nurse</td>
...
<div class="footer-bar">
    <div>
        ...
        <span class="ms-2">© 2024 HealthAlert Systems. All rights reserved. Confidential Medical Data.</span>
    </div>
