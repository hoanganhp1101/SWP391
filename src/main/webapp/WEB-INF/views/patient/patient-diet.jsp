        ...
        <head>
            ...
            <style>
                ...
                * {
                ...
                .meal-card.sang::before {
                    background-color: var(--warning);
                }

                .meal-card.trua::before {
                    background-color: var(--primary);
                }

                .meal-card.toi::before {
        ...
        <body>
            ...
            <nav class="top-nav">
                ...
                <div class="nav-right">
                    ...
                    <i class="fa-solid fa-gear" style="cursor: pointer; font-size: 1.25rem; transition: color 0.2s;"
                        onmouseover="this.style.color='var(--primary)'" onmouseout="this.style.color=''"></i>
            ...
            <div class="app-container">
                ...
                <aside class="sidebar">
                    ...
                    <nav class="sidebar-menu">
                        <a href="${pageContext.request.contextPath}/patient-dashboard" class="menu-btn"><i
                                class="fas fa-chart-pie"></i> Tổng
                            quan</a>
                        <a href="${pageContext.request.contextPath}/patient-medical-profile" class="menu-btn"><i
                                class="fas fa-file-medical"></i> Xem bệnh
                            án cá nhân</a>
                        <a href="#" class="menu-btn"><i class="far fa-calendar-alt"></i> Xem lịch khám</a>
                        <a href="${pageContext.request.contextPath}/patient-prescriptions" class="menu-btn"><i
                                class="fas fa-pills"></i> Đơn thuốc</a>
                        <a href="${pageContext.request.contextPath}/patient-diet" class="menu-btn active"><i
                                class="fas fa-utensils"></i> Thực đơn AI</a>
                ...
                <main class="main-content">
                    <div class="page-header">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/patient-diet"
                    ...
                    <c:if test="${not empty sessionScope.msgError}">
                        <div
                            style="background-color: #fee2e2; color: #ef4444; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; border: 1px solid #f87171;">
                            <i class="fas fa-exclamation-circle"></i> ${sessionScope.msgError}
                        </div>
                    ...
                    <c:if test="${not empty sessionScope.msgSuccess}">
                        <div
                            style="background-color: #d1fae5; color: #10b981; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; border: 1px solid #34d399;">
                            <i class="fas fa-check-circle"></i> ${sessionScope.msgSuccess}
                        </div>
                    ...
                    <c:choose>
                        <c:when test="${empty todayPlan}">
                            <div class="empty-state">
                                ...
                                <p class="empty-text">Hãy để AI của DiabCare gợi ý thực đơn phù hợp nhất với chỉ số
                                    đường huyết và BMI của bạn.</p>
                                <form method="post" action="${pageContext.request.contextPath}/patient-diet"
                                    onsubmit="showLoading()">
                                    <input type="hidden" name="action" value="generate">
                                    <button type="submit" class="btn-generate">
                            ...
                            <div class="diet-container">
                                ...
                                <div class="meal-card sang">
                                    <div class="meal-header">
                                        <div class="meal-title"><i class="fa-solid fa-sun"
                                                style="color:var(--warning)"></i> Bữa Sáng</div>
                                    </div>
                                    <div class="meal-foods">
                                        <c:forEach var="item" items="${todayPlan.chiTietThucPham}">
                                            <c:if
                                                test="${item.buaAn == 'Sáng' || item.buaAn == 'sang' || item.buaAn == 'Sang'}">
                                                <div class="food-item">
                                                    <div class="food-info">
                                                        <h4>${item.thucPhamGoc.tenThucPham}</h4>
                                                        <div class="food-meta">${item.ghiChu != null ? item.ghiChu :
                                                            item.thucPhamGoc.donViKhauPhan}</div>
                                                    </div>
                                                    <div class="food-stats">
                                                        <div class="calo" data-val="${item.thucPhamGoc.caloKcal}">
                                                            ${item.thucPhamGoc.caloKcal} Kcal</div>
                                                        <div class="carbs" data-val="${item.thucPhamGoc.carbsG}">
                                                            ${item.thucPhamGoc.carbsG}g Carbs</div>
                                                    </div>
                                                </div>
                                            </c:if>
                                        </c:forEach>
                                ...
                                <div class="meal-card trua">
                                    <div class="meal-header">
                                        <div class="meal-title"><i class="fa-solid fa-cloud-sun"
                                                style="color:var(--primary)"></i> Bữa Trưa</div>
                                    </div>
                                    <div class="meal-foods">
                                        <c:forEach var="item" items="${todayPlan.chiTietThucPham}">
                                            <c:if
                                                test="${item.buaAn == 'Trưa' || item.buaAn == 'trua' || item.buaAn == 'Trua'}">
                                                <div class="food-item">
                                                    <div class="food-info">
                                                        <h4>${item.thucPhamGoc.tenThucPham}</h4>
                                                        <div class="food-meta">${item.ghiChu != null ? item.ghiChu :
                                ...
                                <div class="meal-card toi">
                                    <div class="meal-header">
                                        <div class="meal-title"><i class="fa-solid fa-moon"
                                                style="color:var(--text-dark)"></i> Bữa Tối</div>
                                    </div>
                                    <div class="meal-foods">
                                        <c:forEach var="item" items="${todayPlan.chiTietThucPham}">
                                            <c:if
                                                test="${item.buaAn == 'Tối' || item.buaAn == 'toi' || item.buaAn == 'Toi'}">
                                                <div class="food-item">
                                                    <div class="food-info">
                                                        <h4>${item.thucPhamGoc.tenThucPham}</h4>
                                                        <div class="food-meta">${item.ghiChu != null ? item.ghiChu :
