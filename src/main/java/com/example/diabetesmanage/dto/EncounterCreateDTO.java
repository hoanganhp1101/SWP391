...
public class EncounterCreateDTO {
    ...
    public static EncounterCreateDTO fromRequest(HttpServletRequest request) {
    ...
    public String resolveEncounterType() {
        String code = encounterType == null ? "" : encounterType.trim().replace('-', '_');
        if ("mau_tong_quat".equalsIgnoreCase(code)
                || "general_blood_test".equalsIgnoreCase(code)
                || "blood_test".equalsIgnoreCase(code)
                || "cbc".equalsIgnoreCase(code)) {
            return "mau_tong_quat";
        }
        if ("sinh_hoa_mau".equalsIgnoreCase(code)
                || "biochemistry_test".equalsIgnoreCase(code)
                || "biochemistry".equalsIgnoreCase(code)
                || "sinh_hoa".equalsIgnoreCase(code)) {
            return "sinh_hoa_mau";
        }
    ...
    public boolean isTaiKhamNoiTiet() {
        return "tai_kham_noi_tiet".equalsIgnoreCase(resolveEncounterType());
    }
    ...
    public void prepareForSave() {
        ...
        String symptoms = firstNonBlank(trimToNull(trieuChung), trimToNull(lyDoKham));
        if (symptoms != null) {
            trieuChung = symptoms;
            lyDoKham = symptoms;
        }

        String chanDoan = trimToNull(chanDoanChinh);
        if (chanDoan != null) {
            chanDoanChinh = chanDoan;
        }

        String tienSu = firstNonBlank(trimToNull(tienSuBenh), trimToNull(quaTrinhBenhLy));
        if (tienSu != null) {
            tienSuBenh = tienSu;
            if (isBlank(quaTrinhBenhLy)) {
                quaTrinhBenhLy = tienSu;
            }
        }
    }
    ...
    public void setKhoaKham(String khoaKham) { this.khoaKham = khoaKham; }
    ...
    public String getPhanLoaiTieuDuong() { return phanLoaiTieuDuong; }
    public void setPhanLoaiTieuDuong(String phanLoaiTieuDuong) { this.phanLoaiTieuDuong = phanLoaiTieuDuong; }
    public String getKhuyenNghiDieuTri() { return khuyenNghiDieuTri; }
    public void setKhuyenNghiDieuTri(String khuyenNghiDieuTri) { this.khuyenNghiDieuTri = khuyenNghiDieuTri; }
    ...
    public Double getLabWbc() { return labWbc; }
    public void setLabWbc(Double labWbc) { this.labWbc = labWbc; }
    public Double getLabRbc() { return labRbc; }
    public void setLabRbc(Double labRbc) { this.labRbc = labRbc; }
    public Double getLabHgb() { return labHgb; }
    public void setLabHgb(Double labHgb) { this.labHgb = labHgb; }
    public Double getLabHct() { return labHct; }
    public void setLabHct(Double labHct) { this.labHct = labHct; }
    public Double getLabPlt() { return labPlt; }
    public void setLabPlt(Double labPlt) { this.labPlt = labPlt; }
    public String getLyDoKham() { return lyDoKham; }
    public void setLyDoKham(String lyDoKham) { this.lyDoKham = lyDoKham; }
    public String getQuaTrinhBenhLy() { return quaTrinhBenhLy; }
    public void setQuaTrinhBenhLy(String quaTrinhBenhLy) { this.quaTrinhBenhLy = quaTrinhBenhLy; }
    ...
    public String getChanDoanChinh() { return chanDoanChinh; }
    public void setChanDoanChinh(String chanDoanChinh) { this.chanDoanChinh = chanDoanChinh; }
    public String getChanDoanPhu() { return chanDoanPhu; }
    public void setChanDoanPhu(String chanDoanPhu) { this.chanDoanPhu = chanDoanPhu; }
    public String getHuongXuTri() { return huongXuTri; }
    public void setHuongXuTri(String huongXuTri) { this.huongXuTri = huongXuTri; }
    ...
    public Double getNhietDoC() { return nhietDoC; }
    public void setNhietDoC(Double nhietDoC) { this.nhietDoC = nhietDoC; }
    ...
    public String getGhiChuSucKhoe() { return ghiChuSucKhoe; }
    public void setGhiChuSucKhoe(String ghiChuSucKhoe) { this.ghiChuSucKhoe = ghiChuSucKhoe; }
    public Double getLabGlucoseMau() { return labGlucoseMau; }
    public void setLabGlucoseMau(Double labGlucoseMau) { this.labGlucoseMau = labGlucoseMau; }
    public Double getLabHba1c() { return labHba1c; }
    public void setLabHba1c(Double labHba1c) { this.labHba1c = labHba1c; }
    public Double getLabCholesterol() { return labCholesterol; }
    public void setLabCholesterol(Double labCholesterol) { this.labCholesterol = labCholesterol; }
    public Double getLabTriglyceride() { return labTriglyceride; }
    public void setLabTriglyceride(Double labTriglyceride) { this.labTriglyceride = labTriglyceride; }
    public Double getLabHdl() { return labHdl; }
    public void setLabHdl(Double labHdl) { this.labHdl = labHdl; }
    public Double getLabLdl() { return labLdl; }
    public void setLabLdl(Double labLdl) { this.labLdl = labLdl; }
    public Double getLabAst() { return labAst; }
    public void setLabAst(Double labAst) { this.labAst = labAst; }
    public Double getLabAlt() { return labAlt; }
    public void setLabAlt(Double labAlt) { this.labAlt = labAlt; }
    public Double getLabUre() { return labUre; }
    public void setLabUre(Double labUre) { this.labUre = labUre; }
    public Double getLabCreatinine() { return labCreatinine; }
    public void setLabCreatinine(Double labCreatinine) { this.labCreatinine = labCreatinine; }
    public String getLabHbsag() { return labHbsag; }
    public void setLabHbsag(String labHbsag) { this.labHbsag = labHbsag; }
    public String getLabAntiHcv() { return labAntiHcv; }
    public void setLabAntiHcv(String labAntiHcv) { this.labAntiHcv = labAntiHcv; }
    public String getLabNuocTieu() { return labNuocTieu; }
    public void setLabNuocTieu(String labNuocTieu) { this.labNuocTieu = labNuocTieu; }
    public String getLabGhiChu() { return labGhiChu; }
    public void setLabGhiChu(String labGhiChu) { this.labGhiChu = labGhiChu; }
    public List<MedicationLineItem> getMedications() { return medications; }
    public void setMedications(List<MedicationLineItem> medications) { this.medications = medications; }
