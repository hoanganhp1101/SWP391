...
public class HealthRecord {
    ...
    public void setNhapBoi(String nhapBoiId) {
        if (nhapBoiId == null || nhapBoiId.isBlank()) {
            this.nhapBoi = null;
            return;
        }
        if (this.nhapBoi == null) {
            this.nhapBoi = new User();
        }
        this.nhapBoi.setId(nhapBoiId);
    }
    ...
    public Boolean getChestPainBoolean() {
        return chestPain;
    }
    ...
    public Integer getChestPain() {
        ...
        return chestPain ? 1 : 0;
    }

    public void setChestPain(Integer chestPain) {
        this.chestPain = chestPain == null ? null : chestPain != 0;
    }

    public Boolean getDizzinessBoolean() {
        return dizziness;
    }
    ...
    public Integer getDizziness() {
        ...
        return dizziness ? 1 : 0;
    }

    public void setDizziness(Integer dizziness) {
        this.dizziness = dizziness == null ? null : dizziness != 0;
    }

    public Boolean getFatigueBoolean() {
        return fatigue;
    }
    ...
    public void setFatigue(Integer fatigue) {
        this.fatigue = fatigue == null ? null : fatigue != 0;
    }
    ...
    public void setThoiGianDo(Timestamp thoiGianDo) {
        this.thoiGianDo = thoiGianDo != null ? thoiGianDo.toLocalDateTime() : null;
    }
    ...
    public void setNgayTao(Timestamp ngayTao) {
        this.ngayTao = ngayTao != null ? ngayTao.toLocalDateTime() : null;
    }
